...
int main()
{
  ...
  do
  {
   ...
   cout<<"\n[1] Buku Baru \n[2] Hapus Daftar Buku \n[3] Cari \n[4] Keluar"<<endl;
    ...
    {
      case 1:
          cout<<"\nID Buku \t\t: "; cin >> ID; fflush(stdin);
          cout<<"Judul Buku \t\t: "; getline(cin, Judul); fflush(stdin);
          cout<<"Penulis Buku \t\t: "; getline(cin, Penulis); fflush(stdin);
          cout<<"Penerbit Buku \t\t: "; getline(cin, Penerbit); fflush(stdin);
          cout<<"Tanggal Terbit \t: "; getline(cin, Tanggal); fflush(stdin);
